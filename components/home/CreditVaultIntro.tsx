...
export const CreditVaultIntro = () => (
  <section>
    ...
    <p className="mt-4">Credit Vaults are tokenized perpetual credit funds. 1 Credit Vault can extend a fixed amount of credit to 150 addresses</p>
    ...
    <ul className="mt-4 ml-8 flex flex-col gap-1.5">
      ...
      <li className="list-disc">After the lockup</li>
    </ul>
