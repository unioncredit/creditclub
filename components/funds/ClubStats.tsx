...
export const ClubStats = ({
  ...
  const stakedBalance: bigint = clubData?.stakedBalance ?? 0n;
  const totalLockedStake: bigint = clubData?.totalLockedStake ?? 0n;
  const unclaimedRewards: bigint = clubData?.unclaimedRewards ?? 0n;
