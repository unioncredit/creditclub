export const creditVaultAbi = [{ "inputs": [], "stateMutability": "nonpayable", "type": "constructor" }, {
  ...
  "type": "error"
}, { "inputs": [], "name": "ExceedsMaxAmount", "type": "error" }, {
  "inputs": [],
  "name": "FailedCall",
  "type": "error"
  ...
  "inputs": [{
    "components": [{ "internalType": "string", "name": "name", "type": "string" }, {
      ...
      "name": "tierEnabled",
      "type": "bool"
    }, { "internalType": "bool", "name": "inviteEnabled", "type": "bool" }, {
      "internalType": "bool",
      "name": "soulBoundNft",
      "type": "bool"
    }, { "internalType": "bool", "name": "vaultTokenEnabled", "type": "bool" }, {
      "internalType": "address[]",
      "name": "initialInvited",
      "type": "address[]"
    }], "internalType": "struct CreditVault.InitParams", "name": "params", "type": "tuple"
