export const rewardsManagerAbi = [
  {
    ...
    "inputs": [
      ...
      {
        "name": "_unitOfCreditPerUnionClub",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
        "name": "_unitOfCreditPerUnionPublic",
        "type": "uint256",
        "internalType": "uint256"
      }
    ],
  ...
  {
    "type": "event",
    "name": "SetClubStatementCreditPrice",
    "inputs": [
      {
  ...
  {
    "type": "event",
    "name": "SetPublicStatementCreditPrice",
    "inputs": [
      {
        "name": "unitOfCreditPerUnion",
        "type": "uint256",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        ...
        "type": "uint8",
        "indexed": true,
        "internalType": "enum IRewardManager.StatementCredit"
      }
    ],
    "anonymous": false
  },
