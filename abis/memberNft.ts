    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IMemberNFT.MemberDetails",
        "components": [
          {
            "name": "referrer",
            "type": "address",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "config",
        "type": "tuple",
        "internalType": "struct IMemberNFT.ConfigParams",
        "components": [
          {
            "name": "gatingToken",
            "type": "address",
